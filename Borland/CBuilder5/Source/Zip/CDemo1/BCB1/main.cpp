...
//---------------------------------------------------------------------------
void __fastcall TMainForm::StringGrid1EndSort( TObject *Sender, long Col ) {
	SetZipTotals();
}

//---------------------------------------------------------------------------
void __fastcall TMainForm::StringGrid1GetCellFormat( TObject *Sender, long Col, long Row, TGridDrawState State, TFormatOptions &FormatOptions ) {
