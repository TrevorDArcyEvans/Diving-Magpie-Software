...
void CRegister::OnOK() 
{
    ...
    if (CheckCode(MachineIDStr, (char *) LPCTSTR(UNFRAG_WORKS_TITLE_CODE), CodeStr) == true)
        {
        MessageBox(_T("Successfully registered!"), UNFRAG_WORKS_TITLE,
        ...
        {
        MessageBox(_T("Incorrect code!"), UNFRAG_WORKS_TITLE,
