...
USERES("DMS_PDFWks.res");
USEUNIT("DMS_PDFWks_ATL.cpp");
USETLB("DMS_PDFWks.tlb");
USEUNIT("DMS_PDFWks_TLB.cpp");
USEUNIT("DMS_PDFWorksImpl.cpp"); /* DMS_PDFWorks: CoClass */
USEFORM("configure.cpp", frmConfig);
USELIB("pdflib.lib");
USEUNIT("jpg2pdf.cpp");
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_PDFWorks, TDMS_PDFWorksImpl)
END_OBJECT_MAP()
