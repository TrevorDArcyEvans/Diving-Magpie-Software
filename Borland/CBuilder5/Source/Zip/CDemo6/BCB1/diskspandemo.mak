...
OBJFILES = DiskSpanDemo.obj Main.obj AddFiles.obj ExtractFiles.obj Message.obj
RESFILES = DiskSpanDemo.res
RESDEPEN = $(RESFILES) Main.dfm AddFiles.dfm ExtractFiles.dfm Message.dfm
LIBFILES = 
DEFFILE = 
# ---------------------------------------------------------------------------
