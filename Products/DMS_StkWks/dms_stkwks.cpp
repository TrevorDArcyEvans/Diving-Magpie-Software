...
USERES("DMS_StkWks.res");
USEUNIT("DMS_StkWks_ATL.cpp");
USETLB("DMS_StkWks.tlb");
USEUNIT("DMS_StkWks_TLB.cpp");
USEUNIT("DMS_StickWorksImpl.cpp"); /* DMS_StickWorks: CoClass */
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_StickWorks, TDMS_StickWorksImpl)
END_OBJECT_MAP()
