...
USERES("DMS_DiffWks.res");
USEUNIT("DMS_DiffWks_ATL.cpp");
USETLB("DMS_DiffWks.tlb");
USEUNIT("DMS_DiffWks_TLB.cpp");
USEUNIT("DMS_DiffWorksImpl.cpp"); /* DMS_DiffWorks: CoClass */
USEFORM("GetInfo.cpp", frmGetInfo);
USEFORM("ShowResults.cpp", frmShowResults);
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_DiffWorks, TDMS_DiffWorksImpl)
END_OBJECT_MAP()
