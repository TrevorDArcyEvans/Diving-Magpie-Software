...
//---------------------------------------------------------------------------
void __fastcall TMainForm::StringGrid1BeginSort( TObject *Sender, int Col, TSortOptions &SortOptions ) {
	StringGrid1->RowCount--;
}
...
void __fastcall TMainForm::StringGrid1GetCellFormat( TObject *Sender, int Col, int Row, TGridDrawState State, TFormatOptions &FormatOptions ) {
	...
	if ( Row == StringGrid1->RowCount - 1 ) {
		...
		FormatOptions.Font->Color = clRed;
	}
}

//---------------------------------------------------------------------------
void __fastcall TMainForm::StringGrid1ClickSort( TObject *Sender, int Col, int Row, TSortOptions &SortOptions ) {
...
//---------------------------------------------------------------------------
void __fastcall TMainForm::StringGrid1DrawCell( TObject *Sender, int Col, int Row, TRect &Rect, TGridDrawState State ) {
	if ( !Row && Col == GSortCol )
