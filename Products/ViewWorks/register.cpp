...
void CRegister::OnOK() 
{
    ...
    if (CheckCode(MachineIDStr, (char *) LPCTSTR(VIEW_WORKS_TITLE_CODE), CodeStr) == true)
        {
        MessageBox(_T("Successfully registered!"), VIEW_WORKS_TITLE,
        ...
        {
        MessageBox(_T("Incorrect code!"), VIEW_WORKS_TITLE,
