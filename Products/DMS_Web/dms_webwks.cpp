...
USERES("DMS_WebWks.res");
USEUNIT("DMS_WebWks_ATL.cpp");
USETLB("DMS_WebWks.tlb");
USEUNIT("DMS_WebWks_TLB.cpp");
USEUNIT("DMS_WebWorksImpl.cpp"); /* DMS_WebWorks: CoClass */
USEFORM("configure.cpp", frmConfigure);
USEUNIT("..\DMS_Common\DMS_Comm_TLB.cpp");
USEUNIT("..\DMS_XML_XSL\XML_XSLLib_TLB.cpp");
USEUNIT("MSXML_TLB.cpp");
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_WebWorks, TDMS_WebWorksImpl)
END_OBJECT_MAP()
