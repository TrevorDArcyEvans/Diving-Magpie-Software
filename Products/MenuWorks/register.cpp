...
void CRegister::OnOK() 
{
    ...
    if (CheckCode(MachineIDStr, (char *) MENU_WORKS_TITLE_CODE, CodeStr) == true)
        {
        MessageBox(_T("Successfully registered!"), MENU_WORKS_TITLE,
        ...
        {
        MessageBox(_T("Incorrect code!"), MENU_WORKS_TITLE,
