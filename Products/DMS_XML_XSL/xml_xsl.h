...
EXTERN_C const IID IID_IDMS_XML2XSL;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE Print( void) = 0;
...
#define IDMS_XML2XSL_Print(This)	\
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IDMS_XML2XSL_Print_Proxy( 
    IDMS_XML2XSL __RPC_FAR * This);


void __RPC_STUB IDMS_XML2XSL_Print_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
