...
void CRegister::OnOK() 
{
    ...
    if (CheckCode(MachineIDStr, (char *) LPCTSTR(WINDOW_WORKS_TITLE_CODE), CodeStr) == true)
        {
        MessageBox(_T("Successfully registered!"), WINDOW_WORKS_TITLE,
        ...
        {
        MessageBox(_T("Incorrect code!"), WINDOW_WORKS_TITLE,
