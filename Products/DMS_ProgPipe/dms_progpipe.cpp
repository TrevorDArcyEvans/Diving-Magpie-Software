...
USERES("DMS_ProgPipe.res");
USEUNIT("DMS_ProgPipe_ATL.cpp");
USETLB("DMS_ProgPipe.tlb");
USEUNIT("DMS_ProgPipe_TLB.cpp");
USEUNIT("DMS_ProgPipeImpl.cpp"); /* DMS_ProgPipe: CoClass */
USEFORM("DMS_ProgDlg.cpp", frmProgDlg);
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_ProgPipe, TDMS_ProgPipeImpl)
END_OBJECT_MAP()
