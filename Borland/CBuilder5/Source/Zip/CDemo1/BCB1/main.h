...
class TMainForm : public TForm {
	__published:	// IDE-managed Components
		...
		void __fastcall StringGrid1GetCellFormat( TObject *Sender, long Col, long Row, TGridDrawState State, TFormatOptions &FormatOptions );
		void __fastcall StringGrid1EndSort( TObject *Sender, long Col );
