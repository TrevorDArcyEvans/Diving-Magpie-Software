...
USERES("DMS_JPGWks.res");
USEUNIT("DMS_JPGWks_ATL.cpp");
USETLB("DMS_JPGWks.tlb");
USEUNIT("DMS_JPGWks_TLB.cpp");
USEUNIT("DMS_JPGWorksImpl.cpp"); /* DMS_JPGWorks: CoClass */
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DMS_JPGWorks, TDMS_JPGWorksImpl)
END_OBJECT_MAP()
