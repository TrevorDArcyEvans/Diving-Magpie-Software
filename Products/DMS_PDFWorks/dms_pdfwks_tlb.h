...
// *********************************************************************//
extern __declspec (package) const GUID LIBID_DMS_PDFWks;
extern __declspec (package) const GUID GUID_tagPDF_PAPER_SIZE;
extern __declspec (package) const GUID GUID_tagPDF_UNITS;
extern __declspec (package) const GUID GUID_tagPDF_Info;
extern __declspec (package) const GUID GUID_tagPDF_ImageSetup;
extern __declspec (package) const GUID GUID_tagPDF_PageSetup;
extern __declspec (package) const GUID GUID_tagPDF_Setup;
extern __declspec (package) const GUID IID_IDMS_PDFWorks;
extern __declspec (package) const GUID CLSID_DMS_PDFWorks;

// *********************************************************************//
// Forward declaration of types defined in TypeLibrary                    
// *********************************************************************//
enum      tagPDF_PAPER_SIZE;
enum      tagPDF_UNITS;
struct    tagPDF_Info;
struct    tagPDF_ImageSetup;
struct    tagPDF_PageSetup;
struct    tagPDF_Setup;
...
typedef IDMS_PDFWorksPtr DMS_PDFWorksPtr;
...
struct tagPDF_PageSetup
{
  ...
  long MarginLeft;
  long MarginRight;
  Dms_pdfwks_tlb::tagPDF_PAPER_SIZE PaperSize;
  long PaperHeight;
  long PaperWidth;
  long Landscape;
  long ScaleToFit;
...
struct tagPDF_Setup
{
  Dms_pdfwks_tlb::tagPDF_PageSetup PageSetup;
  Dms_pdfwks_tlb::tagPDF_Info Info;
  Dms_pdfwks_tlb::tagPDF_ImageSetup ImageSetup;
  Dms_pdfwks_tlb::tagPDF_UNITS Units;
};
...
public:
  virtual HRESULT STDMETHODCALLTYPE Configure(BSTR sTitle/*[in]*/, long* bOK/*[out]*/, 
                                              Dms_pdfwks_tlb::tagPDF_Setup* pPDF_Setup/*[in,out]*/) = 0; // [1]
  ...
  virtual HRESULT STDMETHODCALLTYPE Initialise(Dms_pdfwks_tlb::tagPDF_Setup PDF_Init/*[in]*/) = 0; // [26]
  virtual HRESULT STDMETHODCALLTYPE get_KeepAspectRatio(long* Value/*[out,retval]*/) = 0; // [29]
  virtual HRESULT STDMETHODCALLTYPE set_KeepAspectRatio(long Value/*[in]*/) = 0; // [29]
  virtual HRESULT STDMETHODCALLTYPE get_Amyuni(long* Value/*[out,retval]*/) = 0; // [30]
  virtual HRESULT STDMETHODCALLTYPE set_Amyuni(long Value/*[in]*/) = 0; // [30]
  ...
  long __fastcall get_KeepAspectRatio(void)
  {
    long Value;
    OLECHECK(this->get_KeepAspectRatio((long*)&Value));
    return Value;
  }

  long __fastcall get_Amyuni(void)
  {
    long Value;
    OLECHECK(this->get_Amyuni((long*)&Value));
    return Value;
  }
  ...
  __property   long            KeepAspectRatio = {read = get_KeepAspectRatio, write = set_KeepAspectRatio};
  __property   long            Amyuni = {read = get_Amyuni, write = set_Amyuni};
...
public:
  ...
  HRESULT         __fastcall Configure(BSTR sTitle/*[in]*/, long* bOK/*[out]*/, 
                                       Dms_pdfwks_tlb::tagPDF_Setup* pPDF_Setup/*[in,out]*/);
  ...
  HRESULT         __fastcall Initialise(Dms_pdfwks_tlb::tagPDF_Setup PDF_Init/*[in]*/);
  HRESULT         __fastcall get_KeepAspectRatio(long* Value/*[out,retval]*/);
  long            __fastcall get_KeepAspectRatio(void);
  HRESULT         __fastcall set_KeepAspectRatio(long Value/*[in]*/);
  HRESULT         __fastcall get_Amyuni(long* Value/*[out,retval]*/);
  long            __fastcall get_Amyuni(void);
  HRESULT         __fastcall set_Amyuni(long Value/*[in]*/);
...
public:
  ...
  HRESULT         __fastcall Configure(BSTR sTitle/*[in]*/, long* bOK/*[out]*/, 
                                       /*AUTO_PARAM_ERROR(Dms_pdfwks_tlb::tagPDF_Setup* pPDF_Setup)*/ TVariant&  pPDF_Setup);
  HRESULT         __fastcall set_Icon(long Param1/*[in]*/);
  HRESULT         __fastcall ClipBoardToJPGFile(BSTR sFileName/*[in]*/);
  HRESULT         __fastcall ClipBoardToBMPFile(BSTR sFileName/*[in]*/);
  HRESULT         __fastcall ClipBoardToGIFFile(BSTR sFileName/*[in]*/);
  ...
  BSTR            __fastcall get_InfoKeyWords(void);
  HRESULT         __fastcall set_InfoKeyWords(BSTR Value/*[in]*/);
  HRESULT         __fastcall Initialise(/*AUTO_PARAM_ERROR(Dms_pdfwks_tlb::tagPDF_Setup PDF_Init)*/ TVariant&  PDF_Init);
  HRESULT         __fastcall get_KeepAspectRatio(long* Value/*[out,retval]*/);
  long            __fastcall get_KeepAspectRatio(void);
  HRESULT         __fastcall set_KeepAspectRatio(long Value/*[in]*/);
  HRESULT         __fastcall get_Amyuni(long* Value/*[out,retval]*/);
...
template <class T> HRESULT __fastcall
TCOMIDMS_PDFWorksT<T>::Initialise(Dms_pdfwks_tlb::tagPDF_Setup PDF_Init/*[in]*/)
{
  return (*this)->Initialise(PDF_Init);
}

template <class T> HRESULT __fastcall
TCOMIDMS_PDFWorksT<T>::get_KeepAspectRatio(long* Value/*[out,retval]*/)
{
  return (*this)->get_KeepAspectRatio(Value);
}

template <class T> long __fastcall
TCOMIDMS_PDFWorksT<T>::get_KeepAspectRatio(void)
{
  long Value;
  OLECHECK(this->get_KeepAspectRatio((long*)&Value));
  return Value;
...
template <class T> HRESULT __fastcall
TCOMIDMS_PDFWorksT<T>::set_KeepAspectRatio(long Value/*[in]*/)
{
  return (*this)->set_KeepAspectRatio(Value);
}

template <class T> HRESULT __fastcall
TCOMIDMS_PDFWorksT<T>::get_Amyuni(long* Value/*[out,retval]*/)
{
  return (*this)->get_Amyuni(Value);
}

template <class T> long __fastcall
TCOMIDMS_PDFWorksT<T>::get_Amyuni(void)
{
  long Value;
  OLECHECK(this->get_Amyuni((long*)&Value));
  return Value;
...
template <class T> HRESULT __fastcall
TCOMIDMS_PDFWorksT<T>::set_Amyuni(long Value/*[in]*/)
{
  return (*this)->set_Amyuni(Value);
}
...
{
  _TDispID _dispid(*this, OLETEXT("ClipBoardToJPGFile"), DISPID(3));
  TAutoArgs<1> _args;
...
{
  _TDispID _dispid(*this, OLETEXT("ClipBoardToBMPFile"), DISPID(4));
  TAutoArgs<1> _args;
  _args[1] = sFileName /*[VT_BSTR:0]*/;
  return OleFunction(_dispid, _args);
}
...
{
  _TDispID _dispid(*this, OLETEXT("ClipBoardToGIFFile"), DISPID(5));
  TAutoArgs<1> _args;
  _args[1] = sFileName /*[VT_BSTR:0]*/;
  return OleFunction(_dispid, _args);
}
...
{
  _TDispID _dispid(*this, OLETEXT("ClipBoardToPDFFile"), DISPID(6));
  TAutoArgs<1> _args;
  _args[1] = sFileName /*[VT_BSTR:0]*/;
  return OleFunction(_dispid, _args);
}
...
{
  _TDispID _dispid(*this, OLETEXT("JPGQuality"), DISPID(8));
  TAutoArgs<0> _args;
...
{
  _TDispID _dispid(*this, OLETEXT("MarginTop"), DISPID(9));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("MarginBottom"), DISPID(10));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("PaperSize"), DISPID(11));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("PaperWidth"), DISPID(12));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("PaperHeight"), DISPID(13));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("Landscape"), DISPID(14));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("ScaleToFit"), DISPID(15));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("CentreOnPage"), DISPID(16));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("InfoSubject"), DISPID(17));
  TAutoArgs<0> _args;
...
{
  _TDispID _dispid(*this, OLETEXT("InfoTitle"), DISPID(18));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_BSTR:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("InfoCreator"), DISPID(19));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_BSTR:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("InfoAuthor"), DISPID(20));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_BSTR:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("Units"), DISPID(21));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("MarginLeft"), DISPID(22));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("MarginRight"), DISPID(23));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("ImageHeight"), DISPID(24));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("ImageWidth"), DISPID(25));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("Stretch"), DISPID(27));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  _TDispID _dispid(*this, OLETEXT("InfoKeyWords"), DISPID(28));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_BSTR:1]*/, _args, OlePropertyGet(_dispid, _args));
}
...
template <class T> HRESULT __fastcall
IDMS_PDFWorksDispT<T>::Initialise(/*AUTO_PARAM_ERROR(Dms_pdfwks_tlb::tagPDF_Setup PDF_Init)*/ TVariant&  PDF_Init)
{
  _TDispID _dispid(*this, OLETEXT("Initialise"), DISPID(26));
  TAutoArgs<1> _args;
...
template <class T> HRESULT __fastcall
IDMS_PDFWorksDispT<T>::get_KeepAspectRatio(long* Value/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("KeepAspectRatio"), DISPID(29));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> long __fastcall
IDMS_PDFWorksDispT<T>::get_KeepAspectRatio(void)
{
  long Value;
  this->get_KeepAspectRatio((long*)&Value);
  return Value;
}

template <class T> HRESULT __fastcall
IDMS_PDFWorksDispT<T>::set_KeepAspectRatio(long Value/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("KeepAspectRatio"), DISPID(29));
  TAutoArgs<1> _args;
  _args[1] = Value /*[VT_I4:0]*/;
...
template <class T> HRESULT __fastcall
IDMS_PDFWorksDispT<T>::get_Amyuni(long* Value/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Amyuni"), DISPID(30));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr(Value /*[VT_I4:1]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> long __fastcall
IDMS_PDFWorksDispT<T>::get_Amyuni(void)
{
  long Value;
  this->get_Amyuni((long*)&Value);
  return Value;
}

template <class T> HRESULT __fastcall
IDMS_PDFWorksDispT<T>::set_Amyuni(long Value/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Amyuni"), DISPID(30));
  TAutoArgs<1> _args;
  _args[1] = Value /*[VT_I4:0]*/;
